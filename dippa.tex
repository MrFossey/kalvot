...
\tikzset{
  ...
  line/.style={draw, thick, -latex'},
    ...
    \node [rect, right=of p1] (p4) {Proof of Concept};
    \node [rect, right=of p2] (p5) {Tulokset};
    \node [rect, right=of p3] (p6) {Johtopäätökset};
    \node [rect, left=of p2, xshift=2.0cm] (p0) {Taustat};
