...
\item Miten framework pitäisi rakentaa yleisten testaus- ja Wärtsilän omien vaatimusten sekä teknisen ympäristön valossa?
\end{itemize}
}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{schedule.png}
