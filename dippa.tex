...
\begin{itemize}
\item Ylläpitoprosessien typologian,
\item Palvelunäkökulman ohjelmistoylläpitöön,
\item Elinkaarinäkökulman ohjelmistoihin,
\item Neljä ylläpidon viitekehystä ja näiden vertailun,
\end{itemize}
joista kootaan referenssimalli.
}
...
% vertailussakin kriteeristö, joka esitellään, mutta vedetään vähän hatusta 
