...
Työssä arvioitiin ohjelmistojen huolto/ylläpitöprosesseja (\emph{software maintenenace processes} ohjelmistoyritys Ixonoxelle. \\
Miksi?
\begin{itemize}
\item dkfjasljk
\end{itemize}
...
\subsection{Tutkimusmetodologia }
\frame{ 
Tähän kuva.
}
