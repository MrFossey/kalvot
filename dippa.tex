...
\begin{tabular}{ l p{9cm} }
  \hline \small
  R1 & \footnotesize It shall be possible to run test cases. \\ \small
  R2 & \small It shall be possible to schedule automatic test runs. \\ \small 
  R3 & \small It shall be possible to write and generate test cases. \\ \small
  R4 & \small It shall be possible to capture and replay messages. \\ \small
  R5 & \small It shall be possible to generate mock services or stubs. \\ \small
  R6 & \small It shall be possible to validate test results automatically. \\ \small
  R7 & \small HTTP/XML, JDBC, and (S)FTP messaging protocols shall be supported. \\ \small
  R8 & \small It shall be possible to generate test loads, and conduct load tests. \\ \small
  R9 & \small It shall be possible to generate test loads and conduct stress tests. \\ \small
  R10 & \small It shall be possible to monitor test results and performance metrics. \\ \normal
  \hline  
\end{tabular}
\end{center}
