...
\tikzset{
  base/.style={draw, on chain, on grid, align=center, minimum height=2ex},
  rect/.style={base, rectangle, text width=8em},
  bus/.style={base, rectangle, minimum width=15em, text width=4em},
  line/.style={draw, thick, -latex'},
}
    ...
    \node [rect] (p4) {Proof of Concept};
    \node [rect] (p5) {Tulokset};
    \node [rect] (p6) {Johtopäätökset};
    \node [rect, right=of p2, xshift=2.0cm] (p0) {Taustat};
