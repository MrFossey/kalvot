...
Työssä arvioitiin ohjelmistojen huolto/ylläpitöprosesseja (\emph{software maintenenance processes}) ohjelmistoyritys Ixonos Technology Consulting Ltd:lle. \vspace{10 mm}
Miksi?
\begin{itemize} 
