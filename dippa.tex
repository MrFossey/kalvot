...
Huomioita
Integraatiotestaus tyypillisesti yksikkö- ja järjestelmätestauksen välissä
Integraatiotestauksen strategiat perustuvat kehittäjän näkökulmaan
Karkeasti: bottom-up tai top-down

Regressiotestaus ehkä parempi lähestymiskulma, mutta tässä ei tehdä eroa integraatiotestauksen ja muun testauksen välillä

käytännön mallit: unified testing keissit ennen
