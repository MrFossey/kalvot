...
\begin{tabular}{ l p{9cm} }
  \hline
  \small
  R1 & It shall be possible to run test cases. \\ \small
  R2 & It shall be possible to schedule automatic test runs. \\ \small 
  R3 & It shall be possible to write and generate test cases. \\ \small
  R4 & It shall be possible to capture and replay messages. \\ \small
  R5 & It shall be possible to generate mock services or stubs. \\ \small
  R6 & It shall be possible to validate test results automatically. \\ \small
  R7 & HTTP/XML, JDBC, and (S)FTP messaging protocols shall be supported. \\ \small
  R8 & It shall be possible to generate test loads, and conduct load tests. \\ \small
  R9 & It shall be possible to generate test loads and conduct stress tests. \\ \small
  R10 & It shall be possible to monitor test results and performance metrics. \\ \small
  \hline  
\end{tabular}
\end{center}
