...
Tässä yhteydessä frameworkilla tarkoitetaan teknistä viitekehystä. Se on IT-maailman prosessikartta, eikä ota kantaa käytettävään teknologiatuotteisiin, eikä toimi käyttäjien käyttöoppaana. 
