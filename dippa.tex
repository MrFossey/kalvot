...
\\[0.1in]
Konstruktiivinen tutkmus painottaa käytännönläheisyyttä ja sovellettavuutta ottaen huomioon laatu-, kustannus- ja ajatasaisuustekijät. \citep{rehman2007testing}
}
