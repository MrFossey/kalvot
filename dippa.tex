...
\tikzset{
  ...
  thick,scale=0.8, every node/.style={transform shape}
    ...
    \node [rect, xshift=0.25cm, yshift=2.00cm, fill=white] (s22) {};
    \node [rect, xshift=0.25cm, yshift=2.00cm, fill=white] (s23) {};
    \node [rect, xshift=0.25cm, yshift=2.00cm, fill=white, label=below:{System 2}] (s24) {Service};
    
    \node [rect, right=of s21] (s31) {};
    \node [rect, xshift=0.25cm, yshift=2.00cm, fill=white] (s32) {};
    \node [rect, xshift=0.25cm, yshift=2.00cm, fill=white] (s33) {};
    \node [rect, xshift=0.25cm, yshift=2.00cm, fill=white, label=below:{System 3}] (s34) {Service};
    
    \node [rect, right=of s31] (s41) {};
    \node [rect, xshift=0.25cm, yshift=2.00cm, fill=white] (s42) {};
    \node [rect, xshift=0.25cm, yshift=2.00cm, fill=white] (s43) {};
    \node [rect, xshift=0.25cm, yshift=2.00cm, fill=white, label=below:{System 4}] (s44) {Service};
...
Huomioita
\begin{itemize}
\item Integraatiotestaus tyypillisesti kuvataan välivaiheeksi yksikkö- ja järjestelmätestauksen välillä
\item Integraatiotestauksen strategiat perustuvat ohjelmistokehiyksen näkökulmaan
...
Käytännön mallit ja työkalut nostavat esiin yksittäisiä mielenkintoisia tutkmimuskohteita, kuten mallipohjainen kehitys, testitapausten luomisstrategiat, jatkuva integraatio (CI).
}
