...
Regressiotestaus ehkä parempi lähestymiskulma valmiiden järjestelmien testaukseen, mutta tässä ei tehdä eroa integraatiotestauksen ja muun testauksen välillä.

Käytännön mallit ja työkalut nostavat esiin mielenkintoisia tutkmimuskohteita, kuten mallipohjainen kehitys, testitapausten luomisstrategiat, jatkuva integraatio (CI).
}
