...
\end{itemize}
ja tiivsiti tulokset \bf{ylläpidon tarkistuslistaan} \it{(maintainability checklist)}.
}
...
Referenssimallia kehitettiin edelleen ja siitä muodostettiin uusi asiakaslähtöinen malli.
