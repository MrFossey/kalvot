...
\begin{tabular}{ l p{9cm} }
  \hline \tiny
  R1 & It shall be possible to run test cases. \\ \tiny
  R2 & It shall be possible to schedule automatic test runs. \\ \tiny 
  R3 & It shall be possible to write and generate test cases. \\ \tiny
  R4 & It shall be possible to capture and replay messages. \\ \tiny
  R5 & It shall be possible to generate mock services or stubs. \\ \tiny
  R6 & It shall be possible to validate test results automatically. \\ \tiny
  R7 & HTTP/XML, JDBC, and (S)FTP messaging protocols shall be supported. \\ \tiny
  R8 & It shall be possible to generate test loads, and conduct load tests. \\ \tiny
  R9 & It shall be possible to generate test loads and conduct stress tests. \\ \tiny
  R10 & It shall be possible to monitor test results and performance metrics. \\ \tiny
  \hline  
\end{tabular}
\end{center}
